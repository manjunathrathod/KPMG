...
//Function to read the metadata from url
func readData(url string) []string {
	...
	return data //return data to getMetadata function
}

// Function to get the data from aws metadata url
func getMetaData(url string) MetaData {
	...
	return md //return metadata to main function
}
